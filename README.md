...
**铃·记忆体** 是一款开源、离线优先的 **Windows 桌面智能伙伴**。她不只是一个聊天 AI——她会记住你、看懂屏幕、调用 49 个系统工具、在局域网设备间同步记忆，真正"生活"在你的电脑里。
...
| 能力 | 说明 |
|------|------|
| 💬 对话 | 三种模式：云端 API（DeepSeek / OpenAI 兼容）/ 本地 Ollama / 离线内置文库；3 种人格（日常/中二/治愈）；思考深度 4 档；流式打字机输出 |
